...
func HandleDriverUpdateHTTP(trackerSvc *tracker.Service) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err := trackerSvc.UpdateWorkerLocation(req.ID, *req.Lat, *req.Lng, req.CompanyID); err != nil {
